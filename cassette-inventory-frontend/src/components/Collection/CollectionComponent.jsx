...
import SpotifyPlayerComponent from '../SpotifyPlayer/SpotifyPlayerComponent';
...
const CollectionComponent = () => {
    ...
    const {isLoggedIn, firstName, lastName, officialEmail, setFirstName, cassettes, setCassettes} = useContext(AuthContext);
    ...
    return (
        <>
            <div className={styles.collection_container}>
                {isLoggedIn && <SpotifyPlayerComponent/>}
                {firstName ? <h1 className={styles.collection_title}>{firstName}'s Cassette Collection</h1> : <h1>Cassette Collection</h1>}
                <div>
                    <form>
